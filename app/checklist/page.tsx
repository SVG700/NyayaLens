...
export default function ChecklistPage() {
  const { currentDocument, toggleChecklistItem, addCustomChecklistItem } = useDocument();

  const [showLawyerQuestions, setShowLawyerQuestions] = useState(true);
    ...
    <div className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-subtle space-y-4">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          ...
          <span className="text-xs text-slate-400">Click checkmark to toggle complete</span>
        </div>
        ...
        <form onSubmit={handleAddCustom} className="pt-4 border-t border-slate-100 flex gap-2">
          <input
            type="text"
          ...
          <button
            ...
            className="inline-flex items-center gap-1 px-4 py-2 rounded-lg bg-slate-900 hover:bg-slate-800 disabled:opacity-40 text-white text-xs font-semibold transition"
          >
